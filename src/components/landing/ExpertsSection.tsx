const experts = [
  {
    ...
    role: "Massenklage",
    description:
      "Skaliert Gerechtigkeit durch technologische Überlegenheit.",
    image:
  ...
  },
  {
    ...
    role: "Content",
    description:
      "Übersetzt komplexe Paragraphen in digitale Erlebnisse.",
    image:
  ...
  },
  {
    name: "Loth",
    role: "Marketing",
    description: "Positioniert Innovation dort, wo sie gebraucht wird.",
    image:
  ...
  },
  {
    name: "Ehrke",
    role: "IT",
    description: "Das Herz der Engine. Code statt Chaos.",
    image:
