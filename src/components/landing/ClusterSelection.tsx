      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <Icon name="swords" className="text-4xl text-tertiary-fixed-dim" />
              ...
              <p className="text-secondary-fixed-dim mb-4 leading-relaxed">
                Die{" "}
                <span className="font-bold text-white">Waffenkammer</span>{" "}
          ...
          >
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <Icon name="precision_manufacturing" className="text-4xl text-surface-tint" />
              ...
              <p className="text-secondary mb-4 leading-relaxed">
                Die{" "}
                <span className="font-bold text-on-surface">Efficiency Engine</span>{" "}
